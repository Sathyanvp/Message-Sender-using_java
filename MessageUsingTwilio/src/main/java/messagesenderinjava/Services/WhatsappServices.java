...
import messagesenderinjava.Configuration.WhatsappConfiguration;

@Service
public class WhatsappServices {
	
    private WhatsappConfiguration whatsappconfig;
   
    
    @Autowired
    public WhatsappServices(WhatsappConfiguration whatsappconfig) {
		super();
